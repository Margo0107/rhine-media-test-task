  ...
  return (
    <section className="py-27">
      <div className="mx-auto flex max-w-[1240px] flex-col items-center justify-center px-6 text-center">
        <div className="w-full rounded-4xl border border-white/10 bg-slate-900 px-8 py-20 shadow-[0_30px_80px_rgba(8,18,38,0.35)] backdrop-blur-xl">
          ...
          <h2 className="text-[46px] font-black tracking-[-0.03em] text-white">
            Ready to <span className="text-amber-400">Maximize</span> Your ROI?
          </h2>

          <p className="mx-auto mb-5 mt-2 max-w-2xl max-w-[460px] text-base leading-7 text-slate-400">
            Join the brands and affiliate partners who trust Rhine Media to
            deliver performance at scale, in every major GEO.
          </p>

          <div className="mt-10 flex flex-col items-center justify-center sm:flex-row gap-4">
