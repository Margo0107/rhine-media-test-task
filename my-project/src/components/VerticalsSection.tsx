      ...
      <div className="mx-auto max-w-[1240px] px-6">
        <div className="mb-16 space-y-3">
          ...
          <h2 className="text-center text-5xl font-black tracking-[-0.03em] text-white">
            Niches We <span className="text-amber-400">Dominate</span>
          </h2>
        ...
        <div className="grid gap-[18px] sm:grid-cols-2 xl:grid-cols-4">
          {verticals.map((v) => (
            <div
              key={v.id}
              className="group relative overflow-hidden rounded-[20px] border border-white/5 bg-slate-900 px-6 py-12 transition-all duration-150 hover:border-amber-500/40 hover:bg-slate-800 hover:shadow-[0_22px_55px_rgba(0,0,0,0.32)]"
            >
              {/* Top shimmer bar */}
              ...
              <p className="h-[62px] w-[234px] text-[13px] mb-4 leading-[1.62] text-slate-400">
                {v.desc}
              </p>

              <span className="inline-block rounded-full bg-amber-500/12 px-2.5 py-1 text-[0.69rem] font-bold tracking-[0.07em] text-amber-400 uppercase">
                {v.tag}
              </span>
            </div>
          ))}
