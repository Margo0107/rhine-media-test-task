...
export default function HeroSection() {
  return (
    <>
      <section className="mx-auto flex w-[850px] flex-col gap-10 px-9 py-10 text-white">
        <div className="flex flex-col items-start gap-4 text-left">
          <div className="mb-4 inline-flex w-fit items-center gap-2 gap-3 rounded-full border border-amber-300/20 bg-amber-400/10 px-3.5 py-2 text-[10px] font-bold tracking-[0.3em] text-amber-300 uppercase">
          ...
          <p className="mt-4 max-w-[570px] text-base leading-[1.8] text-slate-400 sm:text-lg">
            We buy traffic for{" "}
        ...
        <div className="mt-2 flex max-w-[700px] gap-10 border-t-1 border-slate-900 pt-8">
          <div className="">
            <p className="text-[25px] font-semibold text-amber-300">$12M+</p>
            <p className="text-xs whitespace-nowrap text-slate-500">
              Monthly Ad Spend
            </p>
          </div>
          <div className="">
            <p className="text-[25px] font-semibold text-amber-300">340%</p>
            <p className="text-xs whitespace-nowrap text-slate-500">
              Average Campaign ROI
            </p>
          </div>
          <div className="">
            <p className="text-[25px] font-semibold text-amber-300">8+</p>
            <p className="text-xs whitespace-nowrap text-slate-500">
              Traffic Channels
            </p>
          </div>
          <div className="">
            <p className="text-[25px] font-semibold text-amber-300">60+</p>
            <p className="text-xs whitespace-nowrap text-slate-500">
              GEOs Worldwide
            </p>
          </div>
