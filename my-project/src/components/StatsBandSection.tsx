export default function StatsBandSection() {
  return (
    <section className="m-auto py-14">
      <div className="flex w-full flex-wrap items-center justify-center gap-20 px-6">
        <div className="p-2 py-2 text-center">
          ...
          <p className="mt-3 text-sm font-semibold text-[var(--t2)]">
            Ad Impressions / Month
          </p>
          <span className="mt-2 block text-xs text-[var(--t3)]">
            Across all traffic sources
          </span>
        </div>

        <div className="border-l border-white/5 p-2 py-2 pl-20 text-center">
          <p className="bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-300 bg-clip-text text-4xl font-extrabold tracking-[-0.03em] text-transparent">
            340%
          </p>
        ...
        <div className="border-r border-l border-white/5 p-15 py-2 pl-14 text-center">
          <p className="bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-300 bg-clip-text text-4xl font-extrabold tracking-[-0.03em] text-transparent">
            7
          </p>
          <p className="mt-3 text-sm font-semibold text-slate-500">
